...
This document defines planned product capabilities that have not yet been built.

All features below are aspirational and have **not** been implemented.

The following **non-negotiable invariants** apply to all features:
