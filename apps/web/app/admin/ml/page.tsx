        ...
        <Layout currentPage="adminMl" userEmail={me.email} userRole={me.role} isAdmin={me.isAdmin} onLogout={logout}>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <label style={{ fontSize: 13, fontWeight: 500, color: '#475569' }}>Start Date</label>
                    <input
                        type="date"
                        value={startDate}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <label style={{ fontSize: 13, fontWeight: 500, color: '#475569' }}>End Date</label>
                    <input
                        type="date"
                        value={endDate}
                ...
                <>
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            { label: 'Top-1 Accuracy', value: formatPercent(metrics.top1Accuracy), color: '#3b82f6', gradient: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)' },
                        ].map((kpi, idx) => (
                            <div key={idx} style={{
                                background: 'white',
                                borderRadius: 16,
                            ...
                            >
                                ...
                                <div style={{ fontSize: 13, fontWeight: 600, color: '#64748b', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.025em' }}>
                                    {kpi.label}
                                </div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <thead>
                                <tr style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                                    <th style={{ padding: '12px 24px', textAlign: 'left', fontSize: 13, fontWeight: 600, color: '#475569' }}>Field Key</th>
                                    <th style={{ padding: '12px 24px', textAlign: 'center', fontSize: 13, fontWeight: 600, color: '#475569' }}>Accepted</th>
                                    <th style={{ padding: '12px 24px', textAlign: 'center', fontSize: 13, fontWeight: 600, color: '#475569' }}>Modified</th>
                                    <th style={{ padding: '12px 24px', textAlign: 'center', fontSize: 13, fontWeight: 600, color: '#475569' }}>Cleared</th>
                                    <th style={{ padding: '12px 24px', textAlign: 'right', fontSize: 13, fontWeight: 600, color: '#475569' }}>Accuracy</th>
                                </tr>
                            </thead>
                            <tbody>
